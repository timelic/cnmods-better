<template>
  ...
  <div class="search-options">
    ...
    >
      <n-select
        ...
        :show="false"
        :value="
          selected_basic_category !== '类别' ? selected_basic_category : null
        "
    ...
    <div class="updateLastWeek-recommend-wrap">
      <span
        ...
        :class="updateLastWeek ? 'updateLastWeek-recommend-item-active' : null"
        @click="handleBtn(true)"
        >上周更新</span
      >
      <span
        class="updateLastWeek-recommend-item"
        :class="recommended ? 'updateLastWeek-recommend-item-active' : null"
        @click="handleBtn()"
        >编辑推荐</span
      >
    </div>
  ...
  <div id="card-wrap">
    ...
    >
      ...
      <div class="abstract" v-html="item.opinion"></div>
      <div class="tags-wrap">
        <span class="tag" :class="item.original ? 'orange' : 'blue'">{{
          item.original ? "原创" : "翻译"
        }}</span>
        <span class="tag orange" v-if="item.updateLastWeek">上周更新</span>
        <span class="tag" v-if="item.moduleVersion">{{
          item.moduleVersion
        }}</span>
        <span class="tag" v-if="item.moduleAge">{{ item.moduleAge }}</span>
