<template>
  <div id="module-wrap">
    ...
    <div
      v-html="module_data.module.opinion"
      class="module-abstract normal-text"
    ></div>
    ...
    <div class="module-part">
      ...
      <div v-for="item in module_data.recommendList">
        <div
          v-html="item.content"
          class="module-part-content normal-text"
        ></div>
        <div class="module-part-small-text pre-space">
          {{
            `${item.loginUser.nickName}   ${item.loginUser.createTime.substring(
              0,
              10
            )}`
          }}
